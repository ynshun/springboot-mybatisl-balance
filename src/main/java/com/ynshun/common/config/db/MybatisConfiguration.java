...
import com.ynshun.common.util.SpringContextUtil;
...
public class MybatisConfiguration {
	...
	public SqlSessionFactory sqlSessionFactorys() throws Exception {
		...
		try {
			...
			// 读取配置
			// sessionFactoryBean.setTypeAliasesPackage("com.ynshun.domain");
	...
	public AbstractRoutingDataSource roundRobinDataSouceProxy() {
		...
		// MyAbstractRoutingDataSource proxy = new
		// MyAbstractRoutingDataSource(readSize);
